...
<?php
    ...
    $result = $conn->query("SELECT * FROM services where id = 6;");
    $prod = $result -> fetch_assoc();
    $hits = $prod["hits"] + 1;
    $conn->query("UPDATE services SET hits = ".$hits." WHERE id = 6;"); 
    $conn->close();
?>
<?php
    if(isset($_COOKIE["lastids"])){
        if(explode(",",$_COOKIE["lastids"])[0]!= 6){
            setcookie("lastids", '6'.",".$_COOKIE["lastids"],time() + (86400 * 30),'/',"esp.sujith.live"); 
        }
        
    }
    else{
        setcookie("lastids", '6', time() + (86400 * 30),'/',"esp.sujith.live");
    }
?>
						...
						<div class="row">
							<div class="col-md-5">
								<div class="project-images">
									<img src="../images/pm1.jpg" alt="">

									<div class="thumbs">
										<a href="#"><img src="../images/pm2.jpg" alt="#"></a>
										<a href="#"><img src="../images/pm3.jpg" alt="#"></a>
										<a href="#"><img src="../images/pm4.jpg" alt="#"></a>
									</div>
								</div>
							</div>
							<div class="col-md-7">
								<div class="project-detail">
									<h2 class="project-title">Project Management/ QA & QC</h2>
									<p>The way to organizes and manages quality and quantity resources that are necessary to complete a project.</p>
