...
<?php
    ...
    $result = $conn->query("SELECT * FROM services where id = 9;");
    $prod = $result -> fetch_assoc();
    $hits = $prod["hits"] + 1;
    $conn->query("UPDATE services SET hits = ".$hits." WHERE id = 9;"); 
    $conn->close();
?>
<?php
    if(isset($_COOKIE["lastids"])){
        if(explode(",",$_COOKIE["lastids"])[0]!= 9){
            setcookie("lastids", '9'.",".$_COOKIE["lastids"],time() + (86400 * 30),'/',"esp.sujith.live"); 
        }
        
    }
    else{
        setcookie("lastids", '9', time() + (86400 * 30),'/',"esp.sujith.live");
    }
?>
						...
						<div class="row">
							<div class="col-md-5">
								<div class="project-images">
									<img src="../images/approval1.jpg" alt="">

									<div class="thumbs">
										<a href="#"><img src="../images/approval2.jpg" alt="#"></a>
										<a href="#"><img src="../images/approval3.jpg" alt="#"></a>
							...
							<div class="col-md-7">
								<div class="project-detail">
									<h2 class="project-title">Statutory Approvals</h2>
									<p>We offer the documentations required for Official approval that is required by law for engaging in a Architectural and Structural detailing of project</p>
