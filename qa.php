						...
						<div class="row">
							<div class="col-md-5">
								<div class="project-images">
									<img src="../images/qa1.jpg" alt="">

									<div class="thumbs">
										<a href="#"><img src="../images/qa2.jpg" alt="#"></a>
										<a href="#"><img src="../images/qa2.jpg" alt="#"></a>
							...
							<div class="col-md-7">
								<div class="project-detail">
									<h2 class="project-title">Review & Quality Auditing</h2>
									<p>Root cause analysis are taken to find flaws in design and implementation quality parameters followed. auditing at the early stage will minimize the cost.</p>
