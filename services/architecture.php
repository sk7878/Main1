						...
						<div class="row">
							<div class="col-md-5">
								<div class="project-images">
									<img src="../images/arch1.jpg" alt="">

									<div class="thumbs">
										<a href="#"><img src="../images/arch2.jpg" alt="#"></a>
										<a href="#"><img src="../images/arch3.jpg" alt="#"></a>
							...
							<div class="col-md-7">
								<div class="project-detail">
									<h2 class="project-title">Architecture and Planning</h2>
									<p>Both are the processes and the products of planning, designing, and constructing buildings.</p>
